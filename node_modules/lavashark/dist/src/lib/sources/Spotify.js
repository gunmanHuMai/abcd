...
class Spotify extends AbstractExternalSource_1.AbstractExternalSource {
    ...
    static USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/100.0.4896.88 Safari/537.36';
    auth;
    market;
    token;
    renewDate;
    constructor(lavashark, clientId, clientSecret, market = 'US') {
        super(lavashark);
    ...
    buildTrack({ name, artists, external_urls: { spotify }, external_ids, duration_ms }) {
        ...
        return new UnresolvedTrack_1.default(this.lavashark, name, artistNames, duration_ms, spotify, 'spotify', external_ids?.isrc);
    }
