...
class LavaShark extends events_1.EventEmitter {
    clientId;
    nodes;
    defaultSearchSource;
    ...
    constructor(options) {
        ...
        for (const node of options.nodes) {
            const newNode = new Node_1.default(this, node);
    ...
    keepCheckNodesState() {
        this.checkNodesStateTimer = setInterval(() => {
            const reconnectPromises = this.nodes.map(async (node) => {
                if (node.state === Node_1.NodeState.DISCONNECTED) {
    ...
    createPlayer(options) {
        ...
        player = new Player_1.default(this, options);
     ...
     */
    async nodePing(node, timeout = 1500) {
